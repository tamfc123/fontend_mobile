...
class CourseDataLoaderForQuizList extends StatelessWidget {
  final String courseId;
  final CourseModel? initialCourse;

  const CourseDataLoaderForQuizList({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    if (initialCourse != null) {
      return ManageQuizScreen(course: initialCourse!);
    }
    ...
    return FutureBuilder<CourseModel>(
      ...
      builder: (context, snapshot) {
        ...
        return ManageQuizScreen(course: snapshot.data!);
      },
    );
  }
}
