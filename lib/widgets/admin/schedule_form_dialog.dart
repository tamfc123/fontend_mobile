...
class _ScheduleFormDialogState extends State<ScheduleFormDialog> {
  ...
  int? _selectedDay;
  String? _selectedRoomId; // ✅ Dùng Room ID
  ...
  void initState() {
    ...
    if (s == null) {
      // Dialog này bây giờ chỉ dành cho Edit. Add dùng màn hình Bulk.
    }
    ...
    _selectedRoomId = s?.roomId; // ✅ Lấy ID phòng từ model
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      await Future.wait([
        adminClassService.fetchAllActiveClasses(),
        roomService.fetchAllActiveRooms(),
      ]);
    });
  }
  ...
  Future<void> _handleSubmit() async {
    ...
    try {
      final classes = context.read<AdminClassService>().allActiveClasses;
      ...
      final updatedSchedule = widget.schedule!.copyWith(
        ...
        roomId: _selectedRoomId, // ✅ Gửi Room ID mới
      ...
      await context.read<AdminScheduleService>().updateSchedule(
        widget.schedule!.id,
        updatedSchedule,
      );
  ...
  // (Các hàm helper build UI giữ nguyên, chỉ sửa phần Dropdown Room)

  @override
  Widget build(BuildContext context) {
    final classes = context.watch<AdminClassService>().allActiveClasses;
    final rooms = context.watch<AdminRoomService>().allActiveRooms;
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: Colors.blue.shade600, // Màu cam cho Edit
