...
class _UserRedemptionDialogState extends State<UserRedemptionDialog> {
  ...
  void initState() {
    super.initState();
    // Gọi API lấy dữ liệu ngay khi mở Dialog
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<AdminRedemptionService>().fetchUserRedemptions(
        widget.user.id,
      );
    });
  }
  ...
  Widget build(BuildContext context) {
    final service = context.watch<AdminRedemptionService>();
    final list = service.redemptions;
