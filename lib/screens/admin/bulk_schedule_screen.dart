...
class _BulkScheduleScreenState extends State<BulkScheduleScreen> {
  // Màu chủ đạo đồng bộ với ManageScreen
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<AdminClassService>().fetchAllActiveClasses();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: backgroundBlue, // Nền xanh nhạt giống Web
      appBar: AppBar(
        title: const Text('Tạo Lịch Học Hàng Loạt'),
        backgroundColor: Colors.white, // AppBar trắng style web
      ...
      body:
          _isLoading
              ...
              : Center(
                child: ConstrainedBox(
                  // Giới hạn chiều rộng để trông giống Form Web chuyên nghiệp
  ...
  // Widget xây dựng 1 dòng Slot (Nằm ngang cho đẹp)
