...
class _ModuleFormDialogState extends State<ModuleFormDialog> {
  ...
  Future<void> _submit() async {
    if (_titleController.text.trim().isEmpty) {
      ToastHelper.showError("Tên chương không được để trống");
      return;
    }
    ...
    try {
      final viewModel = context.read<ManageModuleViewModel>();
      bool success;
      ...
      if (widget.module == null) {
        ...
        success = await viewModel.createModule(createDto);
      } else {
        ...
        success = await viewModel.updateModule(widget.module!.id, module);
      }
