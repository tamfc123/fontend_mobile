...
class TeacherQuizListContent extends StatelessWidget {
  final List<QuizListModel> quizzes;
  final bool isLoading;
  final int currentPage;
  final int pageSize;

  const TeacherQuizListContent({
    super.key,
  ...
  Widget _buildResponsiveTable(
    ...
    final int startingIndex = (currentPage - 1) * pageSize;
              ...
              Padding(
                ...
                child: Center(
                  child: ActionIconButton(
                    ...
                    onPressed: () => _showQuizDetail(context, quiz),
                  ),
                ),
              ),
            ],
  ...
  void _showQuizDetail(BuildContext context, QuizListModel quiz) {
    showDialog(
      context: context,
      builder:
          (ctx) => AlertDialog(
