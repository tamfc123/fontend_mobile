...
class _StudentGiftStoreScreenState extends State<StudentGiftStoreScreen>
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<StudentGiftViewModel>().loadStoreData();
      context.read<StudentGiftViewModel>().loadMyRedemptions();
    });
  }
...
class _StoreTab extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final service = context.watch<StudentGiftViewModel>();
    ...
    return RefreshIndicator(
      onRefresh: () => service.loadStoreData(),
...
class _MyRedemptionTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return RefreshIndicator(
      onRefresh: () => service.loadMyRedemptions(),
