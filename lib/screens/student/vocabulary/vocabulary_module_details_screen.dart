...
class _VocabularyModuleDetailsScreenState
  ...
  void initState() {
    super.initState();
    Future.microtask(() {
      context.read<StudentVocabularyLessonViewModel>().loadLessons(
        widget.module.id,
      );
    });
  }
  ...
  Widget build(BuildContext context) {
    final lessonService = context.watch<StudentVocabularyLessonViewModel>();
  ...
  Widget _buildBody(
    StudentVocabularyLessonViewModel service,
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            ElevatedButton(
              onPressed: () => service.loadLessons(widget.module.id),
