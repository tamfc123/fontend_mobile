...
class _EditProfileStudentScreenState extends State<EditProfileStudentScreen> {
  ...
  void initState() {
    super.initState();
    final profile = context.read<StudentProfileViewModel>().profile;
  ...
  Future<void> _save() async {
    ...
    await context.read<StudentProfileViewModel>().updateProfile(
      name:
    ...
    final error = context.read<StudentProfileViewModel>().error;
    if (error == null) {
      if (!mounted) return;
  ...
  Widget build(BuildContext context) {
    final isLoading = context.watch<StudentProfileViewModel>().isLoading;
