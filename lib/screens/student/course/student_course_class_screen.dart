...
import 'package:mobile/screens/student/course/widgets/confirm_join_class_dialog.dart';
...
class _CourseClassesScreenState extends State<CourseClassesScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<StudentCourseClassViewModel>().loadClassesForCourse(
        widget.course.id!,
      );
    });
  }
  ...
  Widget build(BuildContext context) {
    return Consumer<StudentCourseClassViewModel>(
      builder: (context, viewModel, child) {
        final colorHelper = ColorHelper();
        final levelConfig = colorHelper.getLevelConfig(
          widget.course.requiredLevel,
        );
                ...
                child: Builder(
                  builder: (_) {
                    ...
                    if (viewModel.error != null) {
                      return _buildErrorState(viewModel, levelColor);
                    }
                    ...
                    return Column(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Text(
                            '${viewModel.classes.length} lớp học có sẵn',
                            style: TextStyle(
                              fontSize: 14,
                              fontWeight: FontWeight.w600,
                              color: Colors.grey.shade600,
                        ...
                        Expanded(
                          child: RefreshIndicator(
                            onRefresh: () async {
                              await viewModel.loadClassesForCourse(
                                widget.course.id!,
                              );
                            },
                            color: levelColor,
                            child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                final cls = viewModel.classes[index];
  ...
  Widget _buildErrorState(StudentCourseClassViewModel viewModel, Color color) {
    return Center(
      child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          ...
          ElevatedButton.icon(
            onPressed: () => viewModel.loadClassesForCourse(widget.course.id!),
